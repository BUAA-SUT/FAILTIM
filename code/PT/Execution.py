...
class MyEnv():
    def __init__(self):
        self.workspace_dir = "."
        self.inputs_dir = "/Applications/work/data/MT/FAILTIM/Result/printtokens/input"
        self.outputs_dir = "/Applications/work/data/MT/FAILTIM/Result/printtokens/output"
